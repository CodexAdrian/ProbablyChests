...
subprojects {
    ...
    dependencies {
        ...
        "modImplementation"(group = "software.bernie.geckolib", name = "geckolib-$modLoader-1.21", version = geckolibVersion)
    ...
    if (!isCommon) {
        ...
        tasks {
            "shadowJar"(ShadowJar::class) {
                ...
                exclude("**/probablychests/datagen/**") // Remove data gen code from jar.
            }
    ...
    publishing {
        publications {
            create<MavenPublication>("maven") {
                ...
                pom {
                    name.set("Probably Chests $modLoader")
